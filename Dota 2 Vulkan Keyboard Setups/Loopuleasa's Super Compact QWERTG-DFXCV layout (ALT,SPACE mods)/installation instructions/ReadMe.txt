...
3.	If you wish to have a keyboard layout 99% similar to the old Loopuleasa, run the .ahk or .exe but not both. (Optional)
...
Q: Will I be banned for running the .ahk or .exe?
