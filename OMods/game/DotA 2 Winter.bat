...
"%~dp0\modding_Tools\hllib245\bin\x64\HLExtract.exe" -p "dota\maps\dota_winter.vpk" -d "modding_Tools\VPK CREATOR\dota" -e "maps"
...
"%~dp0\modding_Tools\hllib245\bin\x64\HLExtract.exe" -p "dota\pak01_dir.vpk" -d "modding_Tools\VPK CREATOR\pak01_dir\materials\overviews" -e "materials\overviews\dota_winter.vmat_c"
ren "%~dp0\modding_Tools\VPK CREATOR\pak01_dir\materials\overviews\dota_winter.vmat_c" dota.vmat_c
